defmodule Form do
  ...
  @doc "Generates a string of a given length.\n\nThis string can be used to fill out a form field that is supposed to have no value.
...
@doc "Splits the string into a list of uppercase letters.\n
...
@doc "Checks if the value has no more than the maximum allowed number of letters.\n
